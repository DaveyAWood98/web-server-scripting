...
<html>
	<head>
		<title>Web Server Scripting by David Wood</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header" class="alt">
					<h1><a href="index.html">Web Server Scripting</a> by David Wood</h1>
					<nav id="nav">
						<ul>
							...
							<li>
								...
								<ul>
									...
									<li><a href="myUpload.html">P3 File Handling</a></li>
									<li><a href="create_contact.html">M2 Create a contact!</a></li>
									<li><a href="elements.html">Elements</a></li>
                                    <li><a href="stats.php">Stats</a></li>
									<li>
										<a href="#">Submenu</a>
										<ul>
											<li><a href="error_02.php">error 02</a></li>
											<li><a href="myerrors.log">Option Two</a></li>
											<li><a href="index.php">D2 index</a></li>
